...
export class ObsidianClient {
    ...
    constructor(config) {
        if (!config.apiKey) {
            throw new ObsidianError(createMissingAPIKeyMessage(), 40100 // Unauthorized
            );
        }
        ...
        if (!this.config.verifySSL) {
            logger.warn("WARNING: SSL verification is disabled. While this works for development, it's not recommended for production.\n" +
